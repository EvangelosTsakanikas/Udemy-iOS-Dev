...
//  Dex3
//
//  Created by Νικόλαος Τσακανίκας on 16/11/24.
//
...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.udemylearning.De3Group")!.appending(path: "Dex3.sqlite")
        }
